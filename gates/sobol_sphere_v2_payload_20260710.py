#!/usr/bin/env python3
"""Truth-bank Fly payload for the dependency-free v2 Sobol-sphere gate."""
...
SCRIPT_VERSION = "sobol-sphere-recolor-v2-runtime-feasible"
...
def run_one(shard_index: int, bank_path: Path) -> dict[str, object]:
    ...
    return {
        ...
        "config": {
            ...
            "sobol_transform": "reviewed dependency-free LMS Sobol -> Acklam ndtri -> row_normalize*sqrt(d)",
            "sobol_science_equivalence": "SciPy 1.16.2 uniforms max error 0.0",
