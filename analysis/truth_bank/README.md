...
```bash
make fly-truth-dry FLY_APP=<your-fly-app> FLY_MLPS=100
make fly-truth FLY_APP=<your-fly-app> FLY_MLPS=100
...
```bash
make fly-bank-dry FLY_APP=<your-fly-app> FLY_MLPS=100
make fly-bank FLY_APP=<your-fly-app> FLY_MLPS=100 \
