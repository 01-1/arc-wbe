...
after the L2 sketching, the reference entrant contraction, large-kernel L4, paired-block CRN,
...
- **Mechanistic `L^2` / downstream projection:** closed autonomously.
  ...
  families.
- **the reference entrant contraction clue:** not actionable. The hidden contraction physics
