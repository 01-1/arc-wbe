...
| [ESTIMATOR_HISTORY.md](../../ESTIMATOR_HISTORY.md) | Repository-root estimator experiment log: current route, winning checkpoints, and rejected ideas likely to be retried. |
